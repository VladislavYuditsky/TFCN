package com.yuditsky.serial_port.core;


import com.yuditsky.serial_port.ByteStuffing;
...
public class MessengerCore {
    ...
    public void sendMessage(String message) {
        Runnable runnable = () -> {
            try {
                serialPort.writeBytes(ByteStuffing.doStuffing((message).getBytes()));
            } catch (SerialPortException e) {
                e.printStackTrace();
            }
        };
    ...
    private class PortReader implements SerialPortEventListener {
        ...
        public void serialEvent(SerialPortEvent event) {
            if (event.isRXCHAR() && event.getEventValue() > 0) {
                try {
                    MessengerInterface.showMessage(new String(ByteStuffing.inject(serialPort.readBytes(event.getEventValue())), UTF_8));
                } catch (SerialPortException e) {
                    e.printStackTrace();
                }
            }
